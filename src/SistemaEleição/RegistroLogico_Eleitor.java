...
public class RegistroLogico_Eleitor {
    
    int numEleitor, numSecao;
    String nomeEleitor;
    
    RegistroLogico_Eleitor(){
        
        this(0,"",0);
    }
    
    RegistroLogico_Eleitor(int numeroEleitor, String pNomeEleitor, int numeroSecao){
        
        numEleitor = numeroEleitor;
        nomeEleitor = pNomeEleitor;
